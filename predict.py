...
class Predictor(BasePredictor):
    ...
    def predict(
        ...
        #
        # # 打印本次推理的计时结果
        # print(f"Model Generation Latency: {gen_time:.2f}s | Peak GPU Mem: {gen_max_mem:.2f}MB")
        # print(f"Total CUDA Time: {self.total_cuda_time:.2f}s | Max GPU Mem: {self.max_mem:.2f}MB")
        # #########################################################################

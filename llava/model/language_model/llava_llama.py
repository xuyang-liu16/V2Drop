...
from .V2Drop import V2DropLlamaModel


class LlavaConfig(LlamaConfig):
    model_type = "llava_llama"

class LlavaLlamaModel(LlavaMetaModel, V2DropLlamaModel): # Alter LlamaModel to  V2DropLlamaModel
...
class LlavaLlamaForCausalLM(LlamaForCausalLM, LlavaMetaForCausalLM):
    ...
    def generate(
        ...
        **kwargs,
        ...
        #######################################################
        model_response = super().generate(position_ids=position_ids, attention_mask=attention_mask,
